<p align="center">
    ...
    <h2 align="center">Rosé Pine for theme.park</h2>
</p>
...
We recommend reading [their documentation](https://docs.theme-park.dev/setup/#add-custom-theme-options)
on how to set up the theme for each app.
